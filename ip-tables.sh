...
# Allow SSH (port 22) from internal IP range (192.168.0.0/16)
...
# Allow internal IP range (192.168.0.0/16) to access specific ports in DOCKER-USER
...
iptables -A DOCKER-USER -s 192.168.0.0/16 -p tcp --dport 5000 -j ACCEPT
